...
const Studyoptions = () => {
  return (
    <div className="section-study-option p-5">
      <h2 className="copy-title title-regular pb-4 align-center copy-dark">
      ...
      <div className="row ">
        <div className="col-sm-12 col-md-4 col-lg-4 mb-5">
          ...
          <div className="copy-text p-3 pt-0  custom-col">
            <h3 className="copy-text pb-3 copy-dark">Global Pathways</h3>
            <p className="copy-text pb-3 copy-dark">
              <strong>
                Take the first step towards your New Zealand education with
                Global Pathways.
              </strong>
            </p>
            <p className="copy-text-light pb-3 copy-dark">
            ...
            <p className="copy-text copy-dark">
        ...
        <div className="col-sm-12 col-md-4 col-lg-4 mb-5">
          ...
          <div className="copy-text p-3 pt-0 custom-col">
            <h3 className="copy-text pb-3 copy-dark">Study in New Zealand</h3>
            <p className="copy-text pb-3 copy-dark">
        ...
        <div className="col-sm-12 col-md-4 col-lg-4 mb-5">
          ...
          <div className="copy-text p-3 pt-0  custom-col">
            <h3 className="copy-text pb-3 copy-dark">Study Online</h3>
            <p className="copy-text pb-3 copy-dark">
              <strong>
